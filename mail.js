  ...
  switch (type) {
    ...
    case "message":
      return {
        ...mailOptions,
        subject: "Poruka ✔",
        html: `<div style="width: 80%;margin: 0 auto;padding: 2rem;text-align: center; border: 3px solid #26466d; border-radius: 5px 25px 5px 5px;box-shadow: 0 2px 8px gray;"><h2 style="color: #26466d;">${app}</h2><p><b>Ime pošaljioca:</b> ${name}</p><p><b>E-mail pošaljioca:</b> <a href="mailto:${sender}">${sender}</a></p><p style="width: 75%;margin-bottom: 1rem;"><b>Poruka:</b> ${info}</p></div>`,
      };
    default:
      return null;
  }
